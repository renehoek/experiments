...
class AssignCap:
    ...
    def countWays(self, N):
        ...
        # cap no i
        for ppl in range(N):
            cap_possessed_by_person = map(int, input(f"Cap-ids for person {ppl}").strip().split())
...
# Driver Program
def main():
    No_of_people = int(input("Number of people?"))  # number of persons in every test case
